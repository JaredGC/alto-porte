...
export const CreateLeadForm = ({ onSubmit }: { onSubmit: (values: CreateLeadDto) => void }) => {
    ...
    return (<>
        <button
            ...
            className="bg-black text-white h-12 self-end px-4 rounded-lg hover:bg-white hover:text-black hover:border hover:border-black transition cursor-pointer"
        >
            Nuevo Lead
        </button>
        {isNewLeadModalOpen && (
                        ...
                        {({ isSubmitting }) => (
                            <Form className="grid gap-4">
                                ...
                                <div className="mt-2 flex justify-end gap-3">
                                    ...
                                    <button type="submit" disabled={isSubmitting} className="cursor-pointer rounded-lg bg-black px-4 py-2 text-white">Guardar</button>
                                </div>
                            </Form>
                        )}
                    </Formik>
